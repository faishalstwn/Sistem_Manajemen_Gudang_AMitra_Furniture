        ...
        <div class="col-12 d-flex justify-content-between align-items-start flex-wrap gap-2">
            <div>
                ...
                <p class="text-muted mb-0">
                    Riwayat penerimaan barang dari supplier & stok masuk ke gudang
                </p>
            </div>

            <div class="d-flex gap-2 flex-wrap">
                <a href="{{ route('admin.export.excel.barang-masuk', array_filter([
                    'dari' => request('dari'),
                ...
                <a href="{{ route('admin.export.pdf.barang-masuk', array_filter([
                    'dari' => request('dari'),
                    'sampai' => request('sampai'),
                    'produk_id' => request('produk_id'),
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-3">
                    ...
                    <h4 class="fw-bold mb-0">{{ number_format($totalHariIni ?? 0) }}</h4>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label small fw-semibold">Referensi</label>
                    <input type="text" name="reference" class="form-control form-control-sm"
                           value="{{ request('reference') }}" placeholder="Nomor referensi...">
                </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h6 class="fw-bold mb-0">
                <i class="fas fa-table me-2"></i>Riwayat Barang Masuk
            </h6>
