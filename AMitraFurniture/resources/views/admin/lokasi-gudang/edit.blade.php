        ...
        <div class="col-lg-7">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit {{ $location->kode }}</li>
                </ol>
            </nav>

            <div class="card border-0 shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Lokasi: {{ $location->kode }}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.lokasi-gudang.update', $location) }}">
                        @csrf @method('PUT')
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror"
                                       value="{{ old('kode', $location->kode) }}" required>
                                @error('kode')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="zona" class="form-control @error('zona') is-invalid @enderror"
                                       value="{{ old('zona', $location->zona) }}" required list="zonaOptions">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" name="baris" min="1" class="form-control @error('baris') is-invalid @enderror"
                                       value="{{ old('baris', $location->baris) }}" required>
                                @error('baris')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="number" name="kolom" min="1" class="form-control @error('kolom') is-invalid @enderror"
                                       value="{{ old('kolom', $location->kolom) }}" required>
                                @error('kolom')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="number" name="kapasitas" min="1" class="form-control @error('kapasitas') is-invalid @enderror"
                                       value="{{ old('kapasitas', $location->kapasitas) }}" required>
                                @error('kapasitas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipe" value="rak" id="tipeRak"
                                           {{ old('tipe', $location->tipe) == 'rak' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipe" value="lantai" id="tipeLantai"
                                           {{ old('tipe', $location->tipe) == 'lantai' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipe" value="palet" id="tipePalet"
                                           {{ old('tipe', $location->tipe) == 'palet' ? 'checked' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="keterangan" rows="2" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $location->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
