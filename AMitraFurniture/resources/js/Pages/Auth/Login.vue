...
<template>
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-2">Masuk ke akun A Mitra Furniture Anda</p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <button
                ...
                class="w-full py-3.5 bg-[#1565C0] hover:bg-[#0D47A1] text-white font-semibold rounded-xl shadow-lg shadow-blue-200/50 transition-all duration-200 hover:shadow-xl disabled:opacity-60 disabled:cursor-not-allowed"
            >
        ...
        <p class="mt-8 text-center text-sm text-gray-500">
            Belum punya akun?
            <Link href="/register" class="font-semibold text-[#1565C0] hover:text-[#0D47A1] transition-colors">
                Daftar Sekarang
            </Link>
        </p>
    </div>
